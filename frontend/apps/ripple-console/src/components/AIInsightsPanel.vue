...
.i-pro { background: rgba(56, 191, 248, 0.12); color: var(--cyan); }
.i-risk { background: rgba(244, 105, 92, 0.12); color: var(--red); }
.i-guard { background: rgba(79, 209, 165, 0.12); color: var(--green); }
.i-fc { background: rgba(157, 140, 255, 0.12); color: var(--violet); }
...
.pill {
  ...
  color: var(--cyan); border: 1px solid rgba(56, 207, 232, 0.4);
  border-radius: 999px; padding: 1px 8px;
}
.pill-red { color: var(--red); border-color: rgba(244, 105, 92, 0.4); }

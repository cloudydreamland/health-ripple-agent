    ...
    <div class="lattice-wrap">
      <svg viewBox="0 0 480 430" class="lattice-svg">
        ...
        >
          ...
          <circle :cx="n.x" :cy="n.y" :r="n.flagged ? 3 : 2.2" :fill="n.flagged ? 'var(--red)' : 'var(--muted)'" />
          <g v-if="n.flagged" :transform="`translate(${n.x + 12.5}, ${n.y - 4.6})`" class="lock-mark">
            <rect x="0" y="2.4" width="6.6" height="5.2" rx="1.1" fill="none" stroke="var(--red)" stroke-width="1.1" />
            <path d="M 1.3 2.4 v -1.1 a 2 2 0 0 1 4 0 v 1.1" fill="none" stroke="var(--red)" stroke-width="1.1" />
          </g>
        ...
        <g>
          ...
          <circle :cx="CHOSEN.x" :cy="CHOSEN.y" r="3.4" fill="var(--green)" />
...
.node-flagged { fill: rgba(244, 105, 92, 0.16); stroke: var(--red); stroke-width: 1.8; }
.node-safe { fill: var(--card); stroke: var(--muted); stroke-width: 1.4; }
.node-chosen { fill: rgba(79, 209, 165, 0.14); stroke: var(--green); stroke-width: 1.8; }
.lock-mark { opacity: 0.9; }
.gate-box { fill: rgba(244, 105, 92, 0.1); stroke: var(--red); stroke-width: 1.5; }
.gate-title { font-size: 10px; font-weight: 700; fill: var(--red); font-family: var(--font-mono); letter-spacing: 1px; }
.gate-sub { font-size: 8.5px; fill: var(--muted); }
.chosen-label { font-size: 10.5px; fill: var(--green); font-family: var(--font-mono); font-weight: 700; letter-spacing: 0.5px; }
.lat-annot { font-size: 9px; fill: var(--faint); font-family: var(--font-mono); letter-spacing: 0.8px; }
.lat-stats { display: flex; gap: 16px; font-size: 10.5px; color: var(--muted); letter-spacing: 1px; padding: 0 4px; }
.lat-stats b { color: var(--ink); font-size: 13px; }
.lat-stats .red b { color: var(--red); }

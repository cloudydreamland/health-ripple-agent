...
> 完成时间：2026-09-19T01:46:49 ｜ 后端：http://localhost:18080 ｜ 总评：**全部达标**
...
|---|---|---|---|---|
| `/api/chrono/trigger/1926/feedback` | 2 | 10 | 11 | 11 |
| `/api/chrono/trigger/1927/feedback` | 1 | 11 | 11 | 11 |
| `/api/chrono/triggers/patient/139` | 2 | 18 | 28 | 28 |
| `/api/doctor/login` | 1 | 215 | 215 | 215 |
| `/api/evidence/RIPPLE_DERIVATION-20260919014648-bde38c0d/fhir` | 1 | 25 | 25 | 25 |
| `/api/evidence/ledger` | 1 | 38 | 38 | 38 |
| `/api/evidence/verify` | 1 | 56 | 56 | 56 |
| `/api/health-event/guard-queue` | 2 | 6 | 212 | 212 |
| `/api/health-event/ripple` | 49 | 30 | 37 | 40 |
| `/api/health-event/ripple/feedback-ledger` | 1 | 19 | 19 | 19 |
| `/api/health-event/ripple/forecast` | 3 | 29 | 33 | 33 |
| `/api/health-event/ripple/resolution` | 2 | 8 | 10 | 10 |
| `/api/health-weather/daily` | 6 | 26 | 29 | 29 |
| `/api/mdt/consult` | 1 | 36 | 36 | 36 |
| `/api/patient/login` | 1 | 196 | 196 | 196 |
| `/api/patient/register` | 1 | 239 | 239 | 239 |
| `/api/triage/consult` | 24 | 37 | 47 | 49 |
...
- [✅] **W06** UNRESOLVED → 加强触达至2026-09-19T03:46

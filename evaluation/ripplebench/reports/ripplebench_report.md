...
> 完成时间：2026-09-18T02:09:13 ｜ 后端：http://localhost:18080 ｜ 总评：**全部达标**
...
|---|---|---|---|---|
| `/api/chrono/trigger/1064/feedback` | 2 | 31 | 36 | 36 |
| `/api/chrono/trigger/1086/feedback` | 1 | 35 | 35 | 35 |
| `/api/chrono/triggers/patient/123` | 2 | 26 | 28 | 28 |
| `/api/doctor/login` | 1 | 214 | 214 | 214 |
| `/api/evidence/RIPPLE_DERIVATION-20260918020911-dd989656/fhir` | 1 | 26 | 26 | 26 |
| `/api/evidence/ledger` | 1 | 29 | 29 | 29 |
| `/api/evidence/verify` | 1 | 39 | 39 | 39 |
| `/api/health-event/guard-queue` | 2 | 28 | 174 | 174 |
| `/api/health-event/ripple` | 49 | 29 | 39 | 40 |
| `/api/health-event/ripple/feedback-ledger` | 1 | 7 | 7 | 7 |
| `/api/health-event/ripple/forecast` | 3 | 31 | 34 | 34 |
| `/api/health-event/ripple/resolution` | 2 | 8 | 27 | 27 |
| `/api/health-weather/daily` | 6 | 10 | 31 | 31 |
| `/api/mdt/consult` | 1 | 15 | 15 | 15 |
| `/api/patient/login` | 1 | 224 | 224 | 224 |
| `/api/patient/register` | 1 | 243 | 243 | 243 |
| `/api/triage/consult` | 24 | 36 | 48 | 48 |
...
- [✅] **W06** UNRESOLVED → 加强触达至2026-09-18T04:09
